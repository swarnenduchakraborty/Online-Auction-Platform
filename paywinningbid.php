...
if(isset($_POST['submit']))
{
	...
	$sql ="UPDATE winners SET status='Active' WHERE winner_id='$_GET[winner_id]'";
	$qsql = mysqli_query($con,$sql);
	echo mysqli_error($con);
            ...
            <div class="product-grid8 border">
                <div class="product-image8">
                    <a href="single.php?productid=<?php echo $rsproduct['proid']; ?>">
                        <center><img class="pic-1" src="<?php echo $imgname; ?>" style="width: 300px;height: 250px;"></center>
                    </a>
                    <span class="product-discount-label" style="padding: 4px 15px 4px 75px"><b><?php echo $rsproduct['product_name']; ?></b></span>
                </div>
            </div>
        </div>
