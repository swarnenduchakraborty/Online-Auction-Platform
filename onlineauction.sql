...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2023 at 10:17 PM
...
(3246, 33, 160, 125.00, '2023-05-23 01:31:30', '', 'Active'),
(3247, 33, 160, 150.00, '2023-05-23 01:31:38', '', 'Active'),
(3248, 33, 160, 175.00, '2023-05-23 01:32:45', '', 'Active');
...
(1354, 32, 160, '2023-05-23', 100.00, 'Sell', 'Debit Card', '1234567890123456', '2024-01-01', '159', 'Raj kiran', NULL, '', 'Active'),
(1355, 33, 0, '2023-05-23', 250.00, 'Deposit', 'Debit Card', '1234567890123456', '2024-01-01', '158', 'Raj', NULL, NULL, 'Active'),
(1356, 33, 160, '2023-05-23', 175.00, 'Winners', 'Debit Card', '1234567890123456', '2024-01-01', '159', 'Raj kumar', NULL, NULL, 'Active');
...
(32, 'Rajesh kumar', 'rajeshkumar@gmail.com', 'rajeshkumar', NULL, NULL, NULL, NULL, NULL, '7410850963', NULL, 'Active'),
(33, 'Jaswith kumar', 'jaswithkumar@gmail.com', 'jaswithkumar', '5th floor, KGS gate', 'Karnataka', 'Bangalore', 'BHS colony', '589674', 'jaswithkumar@gm', NULL, 'Active');
...
INSERT INTO `employee` (`employee_id`, `employee_name`, `login_id`, `password`, `status`) VALUES
...
(246, 33, 'Bid', 160, 3246, 1.25, '2023-05-23', 'Active'),
(247, 33, 'Bid', 160, 3247, 1.50, '2023-05-23', 'Active'),
(248, 33, 'Bid', 160, 3248, 1.75, '2023-05-23', 'Active');
...
(15, 160, 33, 175.00, '2023-05-23', 'Active');
...
--
ALTER TABLE `billing`
  MODIFY `billing_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1357;
