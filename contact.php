                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12 plr-0">
                            <div class="contact-address-area">
                                ...
                                <ul>
                                    <li>
                                        <i class="fa fa-fax">&nbsp;</i> Address : Sector-5, Salt-Lake, Kolkata, West Bengal</li>
                                    <li>
                                        <i class="fa fa-phone">&nbsp;</i> +919832104168 </li>
                                    <li>
                                        <i class="fa fa-envelope-o"></i>&nbsp;swarnenduchakraborty40@gmail.com</li>
                                </ul>
                            </div>
                        </div>
