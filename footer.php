...
?>
                                        ...
                                        <div class="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> Online-Auction-Platform<br>Sector-5, Salt-Lake, Kolkata, West Bengal.<br>India</p>
                                                <p>Call us: <span>+919832104168 </span></p>
                                                <p>Email us: <span>swarnenduchakraborty40@gmail.com</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">Copyright &copy; Online Auction Platform. All Rights Reserved</div>
                            </div>	
                            <div class="col-lg-6 col-md-6">
