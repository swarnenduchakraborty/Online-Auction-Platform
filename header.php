...
//default_time_stamp();
$def_projectitle = "Online Auction";
$def_address = "Hash gate, Milesgate road, Bangalore";
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hot-line-area">
                                    <div class="phone">
                                        Customer Support: <span>+919832104168  </span>
                                    </div>
                                </div>
                                <!-- hot-line-area end -->
				...
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
							<h1 class="title1"><span class="text">Online Auction Platform</span></h1>
